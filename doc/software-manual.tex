...
for the HEVC project. It applies to version 16.10
of the software.
\end{abstract}
...
\par
\begin{tabular}{cp{0.45\textwidth}}
  0 & Image DC based method with joint color component decision. \\
  1 & Image DC based method with separate color component decision. \\
